    ...
    <div className="w-full min-h-screen bg-linear-190 from-black via-(--primary-color) to-black flex justify-center items-center px-8 sm:py-5">
      <div className="bg-(--secondary-color) w-full h-auto text-white py-10 px-5 rounded-2xl sm:w-[70%] lg:w-[40%]">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-gray-300 text-sm">Step into the digital sanctuary - Register screen</p>
        </div>
        ...
        <form action='' className="space-y-5">
          ...
          {/* campo 2 */}
          <div>
            <label className="text-(--primary-color) text-sm">E-MAIL</label>
            {/* Dentro do campo input */}
            <div className="relative flex items-center">
              <i className="absolute left-2 fa-solid fa-envelope text-white/70 has-[+input:focus]:text-(--primary-color) transition-all"></i>
              <input type="text" placeholder="email" className="outline-none w-full bg-white/10 py-2 pl-8 pr-2 rounded-md border border-(--primary-color)/30" />
            </div>
          </div>
          ...
          <div className="space-x-2">
            <input type="checkbox" name="" id="" className=" outline-none border accent-purple-500" />
            <span>Stay synced on this device</span>
          </div>
          ...
          {/* Create a account */}
          <p className="">Already have an account? <Link to='/login' href="" className="text-[#2DD4BF] underline">Login</Link></p>
        </form>
      </div>
    </div>
  );
